...
export default function FinalMessageScreen() {
  ...
  const messages = [
    "Hey Nishu Butki Pagluu! 💕",
    "Tu Mere Liye Meri Duniya Hai Re Sirf Duniya Hi Nhi Sab Kuch Hai...",
    "Tu Meri Har Sadness Se Leke Har Khusi Me Sath Rhi...",
    "You've been Strength, My Supporter, Tu Hi Meri Crime Partner Hai! 🎉",
    "Thank you for being the most amazing friend anyone could ask for! ✨",
    "Here's to many more years of friendship, fun, and unforgettable Promises , memories! 🥳",
    "Happy Friendship Day, My Dear Butkiii! 💖",
  ]
